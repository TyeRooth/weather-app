...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n    display: flex;\n    background-color: rgb(0, 153, 255);\n    flex-direction: column;\n}\n\n:root {\n    font-size: 20px;\n}\n\n#search-section {\n    border: 1px solid white;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    padding-top: 30px;\n    gap: 15px;\n}\n\nform { \n    display: flex;\n    background-color: white;\n    padding: 3px 10px;\n    border-radius: 20px;\n    align-items: center;\n    width: 50%;\n    justify-content: space-between;\n}\n\ninput {\n    background: rgba(255, 255, 255, 0);\n    border: none;\n    font-size: 30px;\n}\n\nform button {\n    background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat;\n    background-size: contain;\n    border: none;\n    width: 30px;\n    height: 30px;\n}\n\nform button:hover {\n    background-color: rgb(240, 240, 240);\n}\n\n.error {\n    color: white;\n}\n\n#current-weather-section {\n    border: 1px solid white;\n    display: grid;\n    grid-template-columns: 1fr 1fr 1fr;\n    align-items: center;\n    justify-items: center;\n    justify-content: space-around;\n    color: white;\n    max-height: max-content;\n}\n\n.current-section {\n    display: flex;\n    flex-direction: column;\n    width: 200px;\n    gap: 20px;\n    align-items: center;\n}\n\n.current-item {\n    display: flex;\n    gap: 20px;\n}\n\n.current-item img {\n    height: 1.5rem;\n    filter: invert(100);\n}\n\n.column {\n    display: flex;\n    flex-direction: column;\n}\n\n#forecast-section {\n    border: 1px solid white;\n    display: flex;\n    gap: 20px;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,kCAAkC;IAClC,sBAAsB;AAC1B;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,uBAAuB;IACvB,aAAa;IACb,sBAAsB;IACtB,uBAAuB;IACvB,mBAAmB;IACnB,iBAAiB;IACjB,SAAS;AACb;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,iBAAiB;IACjB,mBAAmB;IACnB,mBAAmB;IACnB,UAAU;IACV,8BAA8B;AAClC;;AAEA;IACI,kCAAkC;IAClC,YAAY;IACZ,eAAe;AACnB;;AAEA;IACI,6DAA+C;IAC/C,wBAAwB;IACxB,YAAY;IACZ,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,oCAAoC;AACxC;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,uBAAuB;IACvB,aAAa;IACb,kCAAkC;IAClC,mBAAmB;IACnB,qBAAqB;IACrB,6BAA6B;IAC7B,YAAY;IACZ,uBAAuB;AAC3B;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,YAAY;IACZ,SAAS;IACT,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,SAAS;AACb;;AAEA;IACI,cAAc;IACd,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,uBAAuB;IACvB,aAAa;IACb,SAAS;AACb","sourcesContent":["body {\n    display: flex;\n    background-color: rgb(0, 153, 255);\n    flex-direction: column;\n}\n\n:root {\n    font-size: 20px;\n}\n\n#search-section {\n    border: 1px solid white;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    padding-top: 30px;\n    gap: 15px;\n}\n\nform { \n    display: flex;\n    background-color: white;\n    padding: 3px 10px;\n    border-radius: 20px;\n    align-items: center;\n    width: 50%;\n    justify-content: space-between;\n}\n\ninput {\n    background: rgba(255, 255, 255, 0);\n    border: none;\n    font-size: 30px;\n}\n\nform button {\n    background: url(\"./icons/search.svg\") no-repeat;\n    background-size: contain;\n    border: none;\n    width: 30px;\n    height: 30px;\n}\n\nform button:hover {\n    background-color: rgb(240, 240, 240);\n}\n\n.error {\n    color: white;\n}\n\n#current-weather-section {\n    border: 1px solid white;\n    display: grid;\n    grid-template-columns: 1fr 1fr 1fr;\n    align-items: center;\n    justify-items: center;\n    justify-content: space-around;\n    color: white;\n    max-height: max-content;\n}\n\n.current-section {\n    display: flex;\n    flex-direction: column;\n    width: 200px;\n    gap: 20px;\n    align-items: center;\n}\n\n.current-item {\n    display: flex;\n    gap: 20px;\n}\n\n.current-item img {\n    height: 1.5rem;\n    filter: invert(100);\n}\n\n.column {\n    display: flex;\n    flex-direction: column;\n}\n\n#forecast-section {\n    border: 1px solid white;\n    display: flex;\n    gap: 20px;\n}"],"sourceRoot":""}]);
// Exports
    ...
    cityCoords.then(coord => {
        fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${ coord[1] }&lon=${ coord[0] }&units=${ units }&appid=b55e6cb5acc75418c397aa9d4a22b7db`, {mode:'cors'})
            ...
            .then(function(response) {
                ...
                ;(0,_utilities__WEBPACK_IMPORTED_MODULE_2__.forecastSwitch)(weather);
            })
            .catch(err => {
                const error = document.querySelector('.error');
                error.textContent = "Location Not Found";        
...
function getCurrentWeather (location) {
    const test = fetch(`http://api.openweathermap.org/data/2.5/weather?q=${ location }&APPID=b55e6cb5acc75418c397aa9d4a22b7db`, {mode:'cors'})
        ...
        .then(function(response) {
            const weather = (0,_object__WEBPACK_IMPORTED_MODULE_0__.objectifyWeather)(response);
            (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.currentDOM)(weather);
